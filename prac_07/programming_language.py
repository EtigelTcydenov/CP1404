...
def run_tests():
    ...
    perl = ProgrammingLanguage("Perl", "Dynamic", True, 1987, False)
    c_plus = ProgrammingLanguage("C++", "Static", False, 1983, True)

    languages = [ruby, python, visual_basic, perl, c_plus]
    print("All languages:")
